...
class HomeGraph extends StatefulWidget {
  static final String view = "HOME_GRAPH";
...
class _HomeGraphState extends State<HomeGraph> {
  ...
  void _processHome(bool isSessionActive) async {
    if (isSessionActive) {
  ...
  void _getChartData() async {
    ...
    var response = await http.post(
        "${Constants.graphURL}$_time&attr=loadPower&cookies=$sessionID&serialNumber=$serialNumber");
