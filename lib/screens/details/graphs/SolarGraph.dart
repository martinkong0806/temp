...
class SolarGraph extends StatefulWidget {
  static final String view = "SOLAR_GRAPH";

  @override
  _SolarGraphState createState() => _SolarGraphState();
}

class _SolarGraphState extends State<SolarGraph> {
  //home screen data
  ...
  void _processSolar(bool isSessionActive) async {
    if (isSessionActive) {
  ...
  void _getChartData() async {
    ...
    var response = await http.post(
        "${Constants.graphURL}$_time&attr=ppv&cookies=$sessionID&serialNumber=$serialNumber");
